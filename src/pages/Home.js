    ...
    <>
      ...
      <section className="bg-white py-5 border-bottom">
        <div className="container">
          <h2 className="mb-3">Neden Tekstil Mağazası?</h2>
          <p className="lead">Tekstil Mağazası, en yeni moda ürünlerini uygun fiyatlarla sunar. Geniş ürün yelpazemiz, hızlı teslimat ve müşteri memnuniyeti odaklı hizmet anlayışımız ile alışverişinizi keyfe dönüştürüyoruz.</p>
